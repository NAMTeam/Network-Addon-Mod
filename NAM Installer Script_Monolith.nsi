...
Section "Göltzsch Viaduct" rail_bridge1
SectionIn 2 3 4
...
Function RRW
  ...
  */
  ...
  ${EndIf}
    SetOutPath "$z___NAM\y_RealRailway\Textures"
...
;Specials (DrivingSide or US/EU)
  ...
  ${Unless} ${SectionIsSelected} ${rail2} ;Non-STR situation
    SetOutPath "$z___NAM\y_RealRailway"
	Delete "$OUTDIR\y_RealRailway\RealRailway_STR.dat"
  ${EndIf}
...
/*  ${ShowConfirmation} ${bridge1} "Basic Additional Bridges" 2
  ...
  ${ShowConfirmation} ${rail_bridge1} "Göltzsch Viaduct" 3
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  ...
  !insertmacro MUI_DESCRIPTION_TEXT ${avenue_bridge1} "Pont Alexandre III is an arch bridge that spans the Seine, connecting the Champs-Élysées quarter and the Invalides and Eiffel Tower quarter; it is widely regarded as the most ornate, extravagant bridge in Paris."
  ...
  !insertmacro MUI_DESCRIPTION_TEXT ${rail_bridge1} "The Göltzsch Viaduct is a railway bridge in Germany. It is the largest brick-built bridge in the world containing more than 26 million custom sized bricks.  (Bridge by choco.)"
  !insertmacro MUI_DESCRIPTION_TEXT ${rail_bridge2} "A concrete railroad bridge modelled and modded by jeronij."
  !insertmacro MUI_DESCRIPTION_TEXT ${rail_bridge3} "A modern rail bridge with an appearance similar to the Garabit Viaduct rail bridge in Southern France. The Garabit Viaduct is a railroad arch bridge spanning the Truyère river near Ruynes-en-Margeride."
  ...
  !insertmacro MUI_DESCRIPTION_TEXT ${rail_bridge9} "Plate Girders are common, cost effective solutions for spans. Not recommended visually for deep spans, but it will work in any height you attempt to use it. It’s a sturdy design that should work well in industrial settings."
  ...
  !insertmacro MUI_DESCRIPTION_TEXT ${rail0} "Covers Maxis-spec version of the Rail network.  Note that no future additions to functionality are planned for Maxis-spec Rail.  This section cannot be selected if RealRailway option is checked."
  ...
  !insertmacro MUI_DESCRIPTION_TEXT ${rail2} "Installs Single-Track Railroads.  Cannot be unselected if RealRailway option is checked."
;  !insertmacro MUI_DESCRIPTION_TEXT ${rail3} "Installs Triple-Track Railroads."
  ...
  !insertmacro MUI_DESCRIPTION_TEXT ${rail6} "Installs Viaduct Rail, which is an elevated version of the standard heavy rail network.  This option includes puzzle pieces.  Draggable Rail Viaducts are part of the RealRailway option."
  ...
  !insertmacro MUI_DESCRIPTION_TEXT ${road_bridge5} "Pont Saint-Michel is a bridge linking the Place Saint-Michel on the left bank of the river Seine to the Île de la Cité. It was named after the nearby chapel of Saint-Michel. (Bridge by xannepan.)"
...
;  !insertmacro MUI_DESCRIPTION_TEXT ${sec17} "Installs the Traffic Simulator Configuration Tool that can be used for creating a custom Traffic Simulator."
  ...
  !insertmacro MUI_DESCRIPTION_TEXT ${TiR_bridge1} "The Pont Notre-Dame is a bridge that crosses the Seine in Paris, France linking the quai de Gesvres on the Rive Droite with the quai de la Corse on the Île de la Cité. (Bridge by xannepan.)"
...
Function .onSelChange
  ...
  ${If} ${SectionIsSelected} ${rail1}
    ...
    !insertmacro SelectSection ${rail2}
  ...
  ${Unless} ${SectionIsSelected} ${rail2}
     !insertmacro UnselectSection ${rail1}
  ${EndIf}
  ...
  ${FlipOptions} ${sec30} $InstalledHSR ${hsr_bridge10} ${hsr_bridge11} ${transit6} ${hsr1} ${hsr2} ${hsr3} ${hsr4} ${hsr5} ${hsr6} ${hsr_tex} 0
...
ValidExec:
  ...
  ${Do}
    ...
    ${If} $1 < 638
    ${AndIf} $3 == ""
      MessageBox MB_YESNO|MB_ICONEXCLAMATION|MB_DEFBUTTON1 "Your version of SimCity 4 does not have a required official patch from EA/Maxis.  The game must be patched to at least version 1.1.638.0 in order for the NAM (and almost all custom content) to work properly.  Do you want to install this patch now?  NOTE: Patching operations WILL NOT WORK on copies bought through Origin, or on NoCD hacks, thus making them incompatible with the NAM." IDYES PatchEP1
      MessageBox MB_OK|MB_ICONINFORMATION "The NAM installer will now exit.  You may rerun it once you have either (a) patched your game at least to version 1.1.638.0, (b) purchased a properly pre-patched digital copy of the game, or (c) if you want the installer to guide you through this patch."
      Quit
PatchEP1:
...
Automata:
    ...
    ${EndIf}
	${SetComponentState} "INRUL Overrides\RealRailway_Core_INRULs.dat" ${rail1} 2 0 32 0
...
;    ${SetComponentState} "Mass Transit Lots\Bus Rapid Transit Stations\Modern Arched Bus Rapid Transit Station.SC4Lot" ${brt2} 2 0 32 0
   ...
   ${SetComponentState} "Mass Transit Lots\Multi-Purpose Stations\BriPizza Arched Station.dat" ${multi3} 2 0 0 0
    ...
    ${SetComponentState} "Real Highway Mod\a_RealHighwayMod_LegacyButtons.dat" ${rhw_op3} 2 0 0 0
