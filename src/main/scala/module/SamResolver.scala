...
class SamResolver extends IdResolver {
	...
	//DxO Intersections		
		...
		add(sam~SE & Ard3~NS, 0x5e682000 + offset) // SAM x Road
		add(sam~SE & Ard3~SN, 0x5e682080 + offset) // SAM x Road
	...
	//DxD Intersections		
		...
		add(sam~EN & Ard3~SE, 0x5e6a2000 + offset) // SAM x Road
		add(sam~EN & Ard3~ES, 0x5e6a2080 + offset) // SAM x Road
