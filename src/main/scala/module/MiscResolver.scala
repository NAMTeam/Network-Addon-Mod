...
class MiscResolver extends IdResolver {
  ...
  val tileMap: scala.collection.Map[Tile, IdTile] = {
    ...
    add(projectLeftSeg(Road~NS) & Rail~NE, 0x03010200, nonMirroredOnly)
    add(projectRightSeg(Road~NS) & Rail~NE, 0x03020500, mirroredOnly)
    add(projectLeftSeg(Road~WN) & Rail~NS, 0x03020100, nonMirroredOnly)
    add(projectRightSeg(Road~WN) & Rail~NS, 0x03020400, mirroredOnly)
    add(projectLeftSeg(Road~ES) & Rail~NE, 0x03020200, nonMirroredOnly)
    add(projectRightSeg(Road~NW) & Rail~NE, 0x03020300, nonMirroredOnly)
    ...
    add(projectLeftSeg(Street~WN) & Rail~NS, 0x5f502600, nonMirroredOnly)
    add(projectRightSeg(Street~WN) & Rail~NS, 0x5f502900, mirroredOnly)
    add(projectLeftSeg(Street~ES) & Rail~NE, 0x5f502700, nonMirroredOnly)
    add(projectRightSeg(Street~NW) & Rail~NE, 0x5f502800, nonMirroredOnly)

    // OWR + intersections
    add(Onewayroad~NS & Rail~WE, 0x09310100)
    add(Onewayroad~NS & Rail~NE, 0x09310200)
    add(Onewayroad~WN & Rail~NS, 0x09320100)
    add(projectLeftSeg(Onewayroad~ES) & Rail~NE, 0x09320200, nonMirroredOnly)
    add(projectRightSeg(Onewayroad~NW) & Rail~NE, 0x09320300, nonMirroredOnly)
    ...
    add(projectLeftSeg(Avenue~SN) & Rail~NE, 0x04001600, nonMirroredOnly)
    add(projectRightSeg(Avenue~SN) & Rail~NE, 0x5d571600, mirroredOnly)
    add(projectLeftSeg(Avenue~NS) & Rail~NE, 0x04001700, nonMirroredOnly)
    add(projectRightSeg(Avenue~NS) & Rail~NE, 0x5d571700, mirroredOnly)
